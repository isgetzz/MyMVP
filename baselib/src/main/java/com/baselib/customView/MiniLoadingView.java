...
public class MiniLoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.MiniLoadingView_mlv_loading_view_size, context.getResources().getDimensionPixelOffset(R.dimen.x15));
        mPaintColor = array.getColor(R.styleable.MiniLoadingView_mlv_loading_view_color, 0x0ff858C96);
        array.recycle();
    }
