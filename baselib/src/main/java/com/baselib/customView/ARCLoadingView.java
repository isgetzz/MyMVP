...
import com.baselib.util.DisplayUtil;
...
public class ARCLoadingView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (null != attrs) {
            ...
            mArcWidth = typedArray.getDimensionPixelSize(R.styleable.LoadingView_lv_width, DisplayUtil.dip2px(DEFAULT_ARC_WIDTH));
            ...
            if (hasIcon) {
                ...
                if (icon != null) {
                    mIconBitmap = BaseUtil.getBitmapFromDrawable(icon);
                } else {
                    Drawable appIcon = BaseUtil.getAppIcon(getContext());
                    if (appIcon != null) {
                        mIconBitmap = BaseUtil.getBitmapFromDrawable(appIcon);
                    }
                }
